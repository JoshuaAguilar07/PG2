...
@section('content')
<div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg max-w-2xl mx-auto my-8">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Nuevo Usuario</h1>
