...
<div class="flex justify-center py-10">
    <div class="w-full max-w-lg bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Editar Proveedor</h1>
        ...
        <form action="{{ route('proveedores.update', $proveedor) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="direccion" rows="3"
                          class="mt-1 w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('direccion', $proveedor->direccion) }}</textarea>
            </div>

            <!-- Activo -->
            <div class="flex items-center gap-2 mb-6">
                <input type="checkbox" name="activo" {{ old('activo', $proveedor->activo) ? 'checked' : '' }}
